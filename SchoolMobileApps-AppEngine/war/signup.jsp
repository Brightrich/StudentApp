...
<head>
    <meta charset="utf-8">
    <title>Signup - BRT Student App - Admin Console</title>
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="index">BRT Student App - Admin Console</a>
            <div class="nav-collapse">
                <ul class="nav pull-right">
                    <li class="">
                        <a href="login" class="">Already have an account? Login now</a>
                    </li>
                    <li class="">
                        <a href="index" class="">
