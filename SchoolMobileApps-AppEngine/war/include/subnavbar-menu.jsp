<div class="subnavbar">
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                <li class="active"><a href="${pageContext.request.contextPath}/index"><i class="icon-dashboard"></i><span>Dashboard</span></a></li>
                <li><a href="${pageContext.request.contextPath}/reports"><i class="icon-list-alt"></i><span>Reports</span></a></li>
